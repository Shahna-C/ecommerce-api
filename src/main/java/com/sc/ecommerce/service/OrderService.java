package com.sc.ecommerce.service;
...
import com.sc.ecommerce.repository.CustomerRepository;
import com.sc.ecommerce.repository.OrderRepository;
import com.sc.ecommerce.repository.ProductRepository;
import com.sc.ecommerce.service.OrderService;
import com.sc.ecommerce.util.OrderStatus;
...
public class OrderService {
	...
	public Order initializeNewOrder ( Set<Long> productIds, Customer customer) {
			...
			order.setInvoiceAmount(calculateOrderTotal(order.getProducts()));
	...
	private double calculateOrderTotal(Set<Product> products) {
		double total = 0;
		for (Product product : products) {
